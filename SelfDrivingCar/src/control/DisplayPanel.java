...
public class DisplayPanel extends Actor {
	...
	private void updateDestinationDistance(double destinationDistance) {
		displayPanelImage.drawString("Distance From Destination: " + destinationDistance, 0, TEXTHEIGHT * destinationDistanceIndex);		
	}
	...
	private void drawDestinationDistance() {
		destinationDistanceIndex = displayIndex;
		displayIndex++;
		displayPanelImage.drawString("Distance From Destination: ", 0, TEXTHEIGHT * destinationDistanceIndex);
	}
